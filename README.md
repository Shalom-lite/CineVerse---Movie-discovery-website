...
> Note: all movies, actors, ratings and posters in this project are
...
|   |-- images/             # backdrop-1 to 8.svg shared by movies + og-image
|   `-- icons/              # favicon.svg
|
`-- README.md
```
...
the `poster` path in `movies.json`). Posters look best around **400x600**
...
and you're done. Same PHP caveat applies.
